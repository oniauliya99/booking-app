...
const PaymentSuccess = async ({
  ...
  return (
    <div className="max-w-screen px-4 mx-auto py-20 mt-12">
      <div className="p-6 md:mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="py-10 text-center">
            <Link
              href={"/myreservation"}
              className="px-12 bg-indigo-600 hover:bg-indigo-500 uppercase text-white font-semibold py-3"
            >
